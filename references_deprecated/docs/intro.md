...
### [시작하기](/docs/getting-started/account-setup)
- 계정 생성 및 초기 설정
- API 키 발급 방법
- 서비스 이용 준비

### [콘솔 가이드](/docs/console-guide/content-scheduling)
- 콘솔 사용법
- 카페 글쓰기 예약 기능
- 자동화 설정 방법
...
:::tip 빠른 시작
처음 사용하시는 분은 [계정 설정 가이드](/docs/getting-started/account-setup)부터 시작해 주세요!
:::