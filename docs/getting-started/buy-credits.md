---
title: Buy Credits
description: How to purchase kvidAI credits via international card payment (Dodo Payments).
slug: buy-credits
sidebar_position: 3
---
...
- Dashboard: [kvid.ai/dashboard](https://kvid.ai/dashboard) — current balance and recent usage.
- Credit history: [kvid.ai/credits](https://kvid.ai/credits).

## Failed or cancelled payment

If the payment is cancelled or declined, you land on `kvid.ai/checkout/cancel` with no charge. Retry from the purchase page.

## Refunds

See our [Refund Policy](https://kvid.ai/refund-policy) on the main site, or contact support@kvid.ai.
